    ...
    <div class="list">
        ...
        <div class="detail_navbar">
            <div class="navbar_content">
                ...
                <router-link to="#">{{cname}}</router-link>
            </div>
        </div>
...
export default {
    ...
    mounted(){
        this.axios.get('/listcid',{params:{cid:this.cid}}).then(res=>{
...
<style scoped>
    ...
    .list_nav{width: 70%;margin: 20px auto 10px;display: flex;justify-content: space-between;}
    .list_nav .nav_logo{margin: 0 40px;}
    ...
    .list_nav .nav_search .input_cont{
        width: 223px;height: 48px;
        padding: 0 10px;
        border: 1px solid #e0e0e0;
        font-size: 14px;
        line-height: 48px;}
    .list_nav .nav_search .seach_img{
